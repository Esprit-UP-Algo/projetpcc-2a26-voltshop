...
bool MainWindow::runPythonStockAnalysis()
{
    ...
    "C:/Users/IMDS/AppData/Local/Python/bin/python.exe";

    const QString scriptDir =
    "C:/Users/IMDS/Documents/AI_Stock_Analysis";

    const QString scriptFile = scriptDir + "/analyse_stock.py";

    if (!QFile::exists(scriptFile)) {
        QMessageBox::critical(this, "DEBUG",
                              "Script introuvable :\n" + scriptFile);
        return false;
    }
    ...
    // ⚠️ Force removal of WindowsApps python conflict
    QString path = env.value("PATH");
    path.remove("C:\\Users\\IMDS\\AppData\\Local\\Microsoft\\WindowsApps;");
    ...
    if (!proc.waitForFinished(30000)) {
        proc.kill();
        QMessageBox::warning(this, "AI Stock Insights",
                             "Timeout: Python ne répond pas.");
        return false;
    }

    QString stderrText = proc.readAllStandardError();
    QString stdoutText = proc.readAllStandardOutput();
