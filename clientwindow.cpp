    ...
    , isDarkMode(false)
{
    ...
    // Set images for statistics labels
    QPixmap clientPix(":/images/ressource/stat.png");
    if (!clientPix.isNull()) {
        ui->clientlabel->setPixmap(clientPix.scaled(ui->clientlabel->size(), Qt::KeepAspectRatio, Qt::SmoothTransformation));
    }
